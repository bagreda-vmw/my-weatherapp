...
```json
{
  "applicationName" : "my-weatherapp",
  "projectName" : "my-weatherapp"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [Sample->my-weatherapp]
...
┃ ┃ ┃ ┃ ┗ ┗ ┗ Debug Path 'Sample.csproj' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.csproj, folder=null, filename=Sample.csproj, g0=Sample.csproj, g1=null, g2=Sample.csproj, g3=Sample.csproj, g4=.csproj} and was rewritten to 'my-weatherapp.csproj'
...
┃ ┃ ┃ ┗ ┗ ┗ ┗  Info Will replace [Sample->my-weatherapp, sample-app->my-weatherapp]
